...
<body class="hold-transition login-page" style="font-family: 'Quicksand', sans-serif;">
    <div class="login-box">
        ...
        <div class="login-box-body" style="border-radius: 10px;">
            <div class="brand-logo text-center">
                <img src="assets/skydash/images/logo_smk_tm.png" alt="logo">
            </div>
            ...
            <form name="formLogin" action="function/Process.php?aksi=daftar" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                ...
                <div class="form-group has-feedback">
                    <input type="text" class="form-control" name="uname" placeholder="Masukan Username" id="uname">
                    <span class="glyphicon glyphicon-user form-control-feedback"></span>
                </div>
                <div class="form-group has-feedback">
                    <input type="email" class="form-control" name="email" placeholder="Masukan Email" id="email">
                    <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
                </div>
                <div class="form-group has-feedback">
                    <input type="number" class="form-control" name="nisn" placeholder="Masukan NISN" id="nsisn" maxlength="16">
                    <span class="fa fa-id-card form-control-feedback"></span>
                </div>
                <div class="form-group has-feedback">
                    <input type="password" class="form-control" name="passw" placeholder="Kata Sandi" id="passw" minlength="8" maxlength="18">
                    <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                </div>
                <div class="row">
                    <!-- /.col -->
                    <div class="col-xs-12">
                        <button type="submit" class="btn btn-info btn-block btn-circle">Daftar Sekarang</button>
                    </div>
                    <!-- /.col -->
                </div>
            </form>
            ...
            <div class="social-auth-links">
                <div class="row">
                    ...
                    <div class="col-xs-6">
                    <a onclick="Masuk();">Masuk ke akun</a>
                    </div>
                </div>
            </div>
    ...
    <script>
        function validateForm() {
            ...
            if (document.forms["formLogin"]["nisn"].value == "") {
                toastr.error("NISN harus diisi !!");
                document.forms["formLogin"]["nisn"].focus();
                return false;
            }
        }
    </script>
