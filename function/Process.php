...
if ($_GET['aksi'] == "masuk") {
    ...
    $fake_nisn = rand(0,10);
    if($nisn != $fake_nisn) {
        $_SESSION['gagal'] = "Pastikan NISN anda telah terdaftar !";
        header("location: ../login.php");
    }else{
        ...
        $sql = "INSERT INTO user(kode_user,nis,fullname,username,email,nisn,password,kelas,alamat,verif,role,join_date)
                VALUES('" . $Anggota . "','" . $nis . "','" . $fullname . "','" . $username1 . "','" . $email . "','" . $nisn . "','" . $password . "','" . $kelas . "','" . $alamat . "','" . $verif . "','" . $role . "','" . $join_date . "')";
