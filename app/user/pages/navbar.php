<header class="main-header">
    ...
    <a href="dashboard" class="logo" style="font-family: 'Quicksand', sans-serif">
        ...
        <span class="logo-lg"><b>Book <i class="fa fa-book"></i></span>
    </a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown messages-menu">
                    ...
                    <ul class="dropdown-menu" id="Pesan">
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                ...
                                ?>
                                    <li>
                                        <!-- start message -->
                                        <a href="views/v_pesan.php?id_pesan=<?= $row_pesan1['id_pesan']; ?>">
                                            <div class="pull-left">
                        ...
                        <li class="footer"><a href="views/v_pesan.php">Lihat semua pesan</a></li>
                    </ul>
                </li>
