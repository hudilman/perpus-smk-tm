...
<body class="hold-transition login-page" style="font-family: 'Quicksand', sans-serif;">
    <div class="login-box">
        ...
        <div class="login-box-body" style="border-radius: 10px;">
            ...
            <h4 class="text-center text-dark">Silahkan login</h4>
            <form name="formLogin" action="function/Process.php?aksi=masuk" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                <div class="form-group has-feedback">
                    <input type="text" class="form-control" name="username" id="username" placeholder="Masukan Username atau email">
                ...
                <div class="row">
                    <!-- /.col -->
                    <div class="col-xs-12">
                        <button type="submit" class="btn btn-info btn-block btn-circle">Masuk</button>
                    </div>
                    <!-- /.col -->
                </div>
            </form>
            ...
            <div class="social-auth-links">
                <div class="row">
                    ...
                    <div class="col-xs-4">
                    <a onclick="Register();">Buat akun</a>
                    </div>
                </div>
            </div>
